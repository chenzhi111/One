...
import com.example.one.adapter.TestAdapter;
import com.example.one.base.BaseMvpActivity;
import com.example.one.interfaces.DataListener;
import com.example.one.model.TestModel;
...
initRecyclerView(mRecyclerView, mRefreshLayout, new DataListener() {
    @Override
